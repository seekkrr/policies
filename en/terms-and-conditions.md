...
These Terms and Conditions ("Terms") govern your use of the SeekKrr mobile application, website, and related services (collectively, the "Platform"), provided by **SOLOQUEST PRIVATE LIMITED** ("Company", "we", "us", or "our"). 
...
SeekKrr is a gamified quest and travel exploration platform. We provide users with curated, self-guided quests that involve real-world navigation and exploration. 
...
- You agree to use the Platform legally and ethically.
- **Real-World Interaction:** SeekKrr quests require you to interact with the real world. You agree to abide by all local laws and regulations, respect private property, and remain aware of your surroundings at all times.
- We are not responsible for any injury, accident, or damage resulting from your use of the Platform in the physical world.
- You must not use the Platform while driving or operating heavy machinery.

## 4. Purchases and Payments
Certain quests and features may require payment. We use third-party payment processors (such as PhonePe). By making a purchase, you agree to their respective terms of service.
- **Taxes:** You are responsible for any applicable taxes related to your purchases.
- **Refunds:** Please review our [Refund Policy](refund-policy.md) for information regarding refunds.
...
- **Phone:** **+91 9310785883**
- **Address:** HIG-29A, Kaushambi Kunj, Kalindipuram, Rajrooppur, Allahabad, Uttar Pradesh, India
